...
window.$ = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // require('./bootstrap');
...
function checkAdvantagesVisible() {
  ...
  if (y > viewportToPixels('60vh')) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.advantages-content').each(function (index) {
...
function checkCtaVisible() {
  ...
  if (y > viewportToPixels('120vh')) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.transition').each(function (index) {
      var elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
      setTimeout(function () {
